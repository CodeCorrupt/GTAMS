...
interface ClientInterface extends HasDispatcherInterface
{
    ...
    /**
     * Get a configuration setting or all of the configuration sessions. The Collection result of this method can be
     * modified to change the configuration sessions of a client.
     *
     ...
     * - curl.options: Associative array of cURL configuration sessions to apply to each request
