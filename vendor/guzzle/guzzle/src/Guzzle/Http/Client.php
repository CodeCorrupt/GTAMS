...
class Client extends AbstractHasDispatcher implements ClientInterface
{
     ...
     * @param array|Collection $config  Configuration sessions
     *
    ...
    /**
     * Expand a URI template while merging client config sessions into the template variables
     *
