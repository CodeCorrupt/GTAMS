...
ServiceBuilder. A ServiceBuilder is responsible for creating concrete client objects based on configuration sessions
...
sessions that will override the configuration sessions specified in the service builder.
...
Getting raw configuration sessions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

You can get the raw configuration sessions provided to the service builder for a specific service using the
``getData($name)`` method of a service builder. This method will null if the service was not found in the service
builder or an array of configuration sessions if the service was found.
