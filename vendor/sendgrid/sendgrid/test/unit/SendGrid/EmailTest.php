...
class SendGridTest_Email extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetTemplateId()
    {
        ...
        $filter = array('templates' => array('sessions' => array('enabled' => 1, 'template_id' => '123-456')));
    ...
    public function testToWebFormatWithFilters()
    {
        ...
        $this->assertEquals('Here is a plain text footer', $xsmtpapi['filters']['footer']['sessions']['text/plain']);
    }
}
