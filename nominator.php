                    ...
                    VALUES ('$ee_email', '$ee_password', '$eeFirstName', '$eeLastName', 'Nominee')"))
    {
                      ...
                      VALUES('$ee_id', '$current_term','$ee_PID','$Is_PhD')"))
      {
                        ...
                        VALUES('$current_term','$ee_id', '$orID', '$ee_rank')"))
        {
          ...
          $ehtml = "Congratulations, $eeFirstName $eeLastName, you have been nominated for a Graduate Teaching Assistantship for the upcoming year. Please use the link below to provide additional information regarding your nomination. \n";
          $ehtml .= "URL      : https://gtass-codecorrupt.c9users.io/nominee.php";  // Can't get to work https://gtass-codecorrupt.c9users.io/nominee.php/$orID
